...
import ch.epfl.bluebrain.nexus.cli.sdk.api.Api.*
import ch.epfl.bluebrain.nexus.cli.sdk.api.model.{ApiResponse, Project}
import ch.epfl.bluebrain.nexus.cli.sdk.{BearerToken, Err, PathUtils, Terminal}
      ...
      .redeemWith(
        {
          ...
          case NonFatal(th)                           => IO.raiseError(th)
        },
        _ => term.writeLn(" Ok")
      )
